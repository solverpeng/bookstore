...
<script type="text/javascript">
	$(function() {
		$("img").click(function() {
			...
			if(position != -1) {
				imgSrc = imgSrc.substring(0, position);
			}
			$("img").attr("src", imgSrc + "?time=" + new Date().getTime());
		});
...
<body>
	...
	<form action="client/UserServlet?method=regist" method="post">
		<table>
			...
			<tr>
				<td>确认密码：</td>
				<td><input type="password" name="repwd" value="123456" /></td>
			</tr>
			...
			<tr>
				<td>验证码：</td>
				<td><input type="text" name="codeParam" class="shorInput"/><img src="client/ValidateColorServlet" /></td>
			</tr>
			<tr>
